 ...
 */
export type Page = 'overview' | 'users' | 'clients' | 'policy' | 'scope-requests' | 'client-registration-requests' | 'email' | 'server' | 'tools';
...
const NAV_ITEMS: NavEntry[] = [
  ...
  { page: 'client-registration-requests', label: 'Client requests', icon: ShieldIcon },
